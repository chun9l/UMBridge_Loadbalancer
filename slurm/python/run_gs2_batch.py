...
samples_scaled = qmc.scale(samples, [0., 0., 2., 0., 0., 0., 0.], [9.0, 0.1, 9., 1., 0.3, 5., 10.]) # tprim, vnewk, qinp, aky, beta, shat, fprim
...
for i in range(nsample):
    ...
    os.system(f"cp ../gs2_batch.sh {iteration_dir}")
    ...
    Batch.iterations.append(iteration(iteration_dir, settings, batch_file=f"{iteration_dir}/gs2_batch.sh"))
